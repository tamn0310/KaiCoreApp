   ...
   public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (_context.ProductCategories.Count() == 0)
            {
                ...
                {
                    new ProductCategory() { Name="Mô hình dragonball",SeoAlias="mo-hinh-dragon-ball",ParentId = null,Status=Status.Active,SortOrder=1,
                    ...
                    new ProductCategory() { Name="Mô hình Marvel",SeoAlias="mo-hinh-marvel",ParentId = null,Status=Status.Active ,SortOrder=2,
                        Products = new List<Product>()
                        {
                    ...
                    new ProductCategory() { Name="Mô hình DC",SeoAlias="mo-hinh-dc",ParentId = null,Status=Status.Active ,SortOrder=3,
                        Products = new List<Product>()
                        {
                    ...
                    new ProductCategory() { Name="Mô hình One Picie",SeoAlias="mo-hinh-one-picie",ParentId = null,Status=Status.Active,SortOrder=4,
                        Products = new List<Product>()
                        {
